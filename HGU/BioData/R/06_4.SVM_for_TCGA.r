...
for(i in 0:4){
  result <- data.frame()
  data <- read.csv(paste0("/home/tjahn/Data/input_ensemble_TCGA_TARGET_GTEx/TCGA_selected_model_",i,"_data.csv"), sep = ",", header = T)
  ...
  write.csv(result,paste0("/home/tjahn/tf_save_data/sungmin/result/SVM/TCGA_radial_result_",i,".csv"))
}
