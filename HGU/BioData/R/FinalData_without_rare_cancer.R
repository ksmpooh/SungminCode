...
Before_data <- read.csv("C:/Users/bibs-student/Desktop/성민_DNN/FinalData_GSM_gene_index_result.csv",header = T, sep = ",",row.names = 1)
Before_data <- Before_data[,-which(names(Before_data)%in%"index")]
CancerCode <-read.csv("C:/Users/bibs-student/Desktop/성민_DNN/GPL570_sampleinfo.txt",sep = "\t",header = T)
...
write.csv(After_data,"C:/Users/bibs-student/Desktop/성민_DNN/FinalData_GSM_gene_index_result_without_rare_cancer.csv")
