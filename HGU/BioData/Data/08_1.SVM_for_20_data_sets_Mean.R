...
mother <- read.csv("/home/tjahn/Data/TCGA_with_GEO/Mother/for_Model_Generation/TCGA_with_GEO_input_ensemble_Mean_3000.csv",header = T,sep = ',')
...
write.csv(result,"/home/tjahn/tf_save_data/sungmin/result/SVM/SVM_2018_07_16/Mean_result_20_data_set.csv",row.names = F)
