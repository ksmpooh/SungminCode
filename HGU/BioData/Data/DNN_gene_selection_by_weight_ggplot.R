...
gene <- read.csv("C:/Users/bibs-student/Desktop/result_to_find_best_model/without_rare_cancer.csv",sep = ",",header = T)
gene<-gene[,2:6]
...
ggplot(data,aes(x=Gene_Elimination,y=Accuracy))+
  ...
  theme_bw()+
  labs(titles = "DNN Gene Selection without Rare Cancer",y="Accuracy")+
