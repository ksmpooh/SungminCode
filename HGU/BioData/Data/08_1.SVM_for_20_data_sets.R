...
lists <- c("CV","VAR","Mean","foundation_2267","foundation_308")

for(list in lists){
  assign("mother",read.csv(paste0("/home/tjahn/Data/TCGA_with_GEO/Mother/for_Model_Generation/TCGA_with_GEO_input_ensemble_",list,"_3000.csv"),header = T,sep = ','))
  for(i in 1:20){
...
write.csv(result,"/home/tjahn/tf_save_data/sungmin/result/SVM/SVM_2018_07_05/result_20_data_set.csv",row.names = F)
