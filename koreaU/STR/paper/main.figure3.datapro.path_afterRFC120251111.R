## main.figure3 .data processing # patho # after chrX , with PRC1 20241111
# RFC1 == complex
# AP, mapQ, baseQ
...
#eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC 
#filter(STR_ID != "RFC1")
eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC %>% group_by(ID) %>% summarise(AP_mean = mean(TRGT_AP)) -> AP_mean_byID_simpleSTR
head(AP_mean_byID_simpleSTR)
write.table(AP_mean_byID_simpleSTR,"~/Desktop/KU/@research/STR/figure/figure3/f3.AP_mean_byID_simpleSTR.afterchrXQC.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC %>% mutate(AP0.5 = ifelse(TRGT_AP >0.5,"(0.5~1]","[0~0.5]")) %>% 
...
write.table(concordacne_byID_AP_simpleSTR_afterchrXQC,"~/Desktop/KU/@research/STR/figure/figure3/f3.concordacne_byID_AP0.5_simpleSTR_afterchrXQC.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
#head(concordacne_byID_AP_simpleSTR_afterchrXQC)
write.table(concordacne_byID_AP0.5_str_length_simpleSTR_afterchrXQC,"~/Desktop/KU/@research/STR/figure/figure3/f3.concordacne_byID_AP0.5_str_length_simpleSTR_afterchrXQC.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
write.table(concordacne_byID_AP0.5_strlength_simpleSTR_afterchrXQC,"~/Desktop/KU/@research/STR/figure/figure3/f3.concordacne_byID_AP0.5_strlength_simpleSTR_afterchrXQC.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
a %>% write.table("~/Desktop/KU/@research/STR/figure/figure3/f3.STR.allele.count.byAP.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
b %>% group_by(TRGT_AP) %>%
  ...
  write.table("~/Desktop/KU/@research/STR/figure/figure3/f3.STR.allele.count.match.byAP.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
c %>% write.table("~/Desktop/KU/@research/STR/figure/figure3/f3.sample.concordance.rate.byAP.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
d %>% write.table("~/Desktop/KU/@research/STR/figure/figure3/f3.sample.concordance.rate.bySTR_length_AP.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC %>% 
  ...
  count(check) -> e
head(e)
e %>% write.table("~/Desktop/KU/@research/STR/figure/figure3/f3.match.count.bySTR_length_AP.txt",col.names = T,row.names = F,quote = F,sep = "\t")

## ap by simple patho simple_patho complex
## RFC1 -> complex
patho_complex_processing <- read_table("~/Desktop/KU/@research/STR/figure/figure3/old_complex/pathogenic.all.allele.strlength.compare.txt")
patho_complex_processing <- read_table("~/Desktop/KU/@research/STR/figure/df_merge/complex_pathogenic_STR_prep.EH_TRGT_merged_afterchrXQC.txt")
...
eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC %>% select(ID,STR_ID,TRGT_AP,allele) %>% 
...
write.table(APmean_byID_allSTR,"/Users/ksmpooh/Desktop/KU/@research/STR/figure/sup.figure/AP/APmean_byID_allSTR.afterchrXQC.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
write.table(APmean_byID_bySTRtype,"/Users/ksmpooh/Desktop/KU/@research/STR/figure/sup.figure/AP/APmean_byID_bySTRtype.afterchrXQC.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
#          rename(AP = TRGT_AP,AM = TRGT_AM) %>% left_join(final_ref %>% mutate(RU.length = str_length(MOTIFS)) %>% select(ID,RU.length) %>% rename(STR_ID = ID))) %>%
  ...
  rbind(eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC %>% 
          mutate(TRGT_AP = ifelse(TRGT_AP == -1,0,TRGT_AP)) %>%
          left_join(final_ref_pro) %>% 
...
a %>% write.table("/Users/ksmpooh/Desktop/KU/@research/STR/figure/sup.figure/AP/STR.allele.count.byAP.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
b %>% group_by(TRGT_AP) %>%
  mutate(prop = prop.table(n)) %>%
  write.table("/Users/ksmpooh/Desktop/KU/@research/STR/figure/sup.figure/AP/STR.allele.count.match.byAP.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
c %>% write.table("/Users/ksmpooh/Desktop/KU/@research/STR/figure/sup.figure/AP/sample.concordance.rate.byAP.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
d %>% write.table("/Users/ksmpooh/Desktop/KU/@research/STR/figure/sup.figure/AP/sample.concordance.rate.bySTR_length_AP.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
AP_STRlength_all_STRallele %>% 
  ...
  count(check) -> e
head(e)
e %>% write.table("/Users/ksmpooh/Desktop/KU/@research/STR/figure/sup.figure/AP/match.count.bySTR_length_AP.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
#head(concordacne_byID_AP_simpleSTR_afterchrXQC)
write.table(concordacne_byID_AP_allSTR_afterchrXQC,"/Users/ksmpooh/Desktop/KU/@research/STR/figure/sup.figure/AP/concordacne_byID_AP0.5_allSTR_afterchrXQC.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
write.table(concordacne_byID_AP0.5_str_length_allSTR_afterchrXQC,"/Users/ksmpooh/Desktop/KU/@research/STR/figure/sup.figure/AP/concordacne_byID_AP0.5_str_length_allSTR_afterchrXQC.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
write.table(concordacne_byID_AP0.5_strlength_simpleSTR_afterchrXQC,"/Users/ksmpooh/Desktop/KU/@research/STR/figure/sup.figure/AP/concordacne_byID_AP0.5_strlength_allSTR_afterchrXQC.txt",col.names = T,row.names = F,quote = F,sep = "\t")
...
dim(concordance_bySTR_simpleSTR.bamQC.INFO.afterchrXQC)

concordance_bySTR_simpleSTR.bamQC.INFO.afterchrXQC %>% filter(STR_ID == "RFC1")
...
concordance_bySTR_simpleSTR.bamQC.INFO.afterchrXQC %>% #��head()
  mutate(concordance_rate_range = case_when(
...
normalSTR.STRlength100.with.bamstats <- read_table("~/Desktop/KU/@research/STR/figure/figure4/old/normalSTR.STRlength100.with.bamstats.txt")
head(normalSTR.STRlength100.with.bamstats)

pathoSTR.STRlength.with.bamstats <- read_table("~/Desktop/KU/@research/STR/figure/figure4/old/pathoSTR.STRlength.with.bamstats.txt")
...
eh_cov <- read_table("~/Desktop/KU/@research/STR/eh/eh_simpleSTR_oribam_coverage.txt") %>% select(meandepth:ID) %>% filter(STR_ID %in% simple_STR$STR_ID)
eh_cov %>% filter(STR_ID == 'RFC1')
head(eh_cov)
eh_cov %>% filter(ID == "NIH23F1724125") %>% filter(!str_detect(STR_ID,"chr")) -> a
a
#eh_cov_patho <- read_table("~/Desktop/KU/@research/STR/eh/") #%>% select(meandepth:ID) %>% filter(STR_ID %in% common_STR$STR_DB)
...
dim(concordance_bySTR_simpleSTR.afterchrXQC_0)

head(merge_coverage)

merge_coverage <- read_table("~/Desktop/KU/@research/STR/figure/sup.figure/concordance_bySTR_simpleSTR.bamQC.INFO.afterchrXQC")
head(merge_coverage)
...
head(eh_cov)
head(trgt_cov)
head(concordance_bySTR_simpleSTR.afterchrXQC_0)
...
write.table(trgt_eh_cov_merge_concordance0,"~/Desktop/KU/@research/STR/figure/figure3/f3.trgt_eh_cov_merge_concordance0",col.names = T,row.names = F,quote = F,sep = "\t")
...
trgt_eh_cov_merge_concordance0 %>% ggplot(aes(x=meanmapq,fill=platform)) +
  geom_density()

trgt_eh_cov_merge_concordance0 %>% ggplot(aes(x=meandepth,fill=platform)) +
  geom_density()
...
trgt_cov %>% filter(STR_ID %in% concordance_bySTR_simpleSTR.afterchrXQC_0$STR_ID) -> trgt_cov_0
eh_cov %>% filter(STR_ID %in% concordance_bySTR_simpleSTR.afterchrXQC_0$STR_ID) -> eh_cov_0

head(trgt_cov_0)

trgt_cov_0 %>% left_join(eh_cov_0) %>% #head()
  ggplot(aes(x=trgt_meanmapq,y=eh_meanmapq)) +
  geom_point() -> a
...
eh_cov_0 %>% filter(eh_meanmapq == 0) -> eh_comv
head(eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC)

trgt_cov_0 %>% left_join(eh_cov_0)  %>% filter(eh_meanmapq == 0) %>% left_join(eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC) -> a
#eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC %>% 

a %>% ggplot(aes(x=TRGT_STR,y=EH_STR)) + 
  geom_point()
a
ggMarginal()
head(eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC)
eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC %>% filter(check == 0) -> eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC_check0
head(eh_cov)
head(trgt_cov)
eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC %>% select(ID,STR_ID,allele,check) %>% 
  left_join(eh_cov %>% select(ID,STR_ID,eh_meanmapq)) %>%
  left_join(trgt_cov %>% select(ID,STR_ID,trgt_meanmapq)) -> a

eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC_check0 %>% 
  left_join((eh_cov %>% select(ID,STR_ID,eh_meanmapq)) %>%
  left_join(trgt_cov %>% select(ID,STR_ID,trgt_meanmapq))) -> a

head(a)
a %>% mutate(diff = TRGT_STR - EH_STR) %>% count(abs(diff))
  ggplot(aes(x=trgt_meanmapq,y=eh_meanmapq)) + 
  geom_hex(bins=30)

head(eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC_check0)

head(eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC_check0)

eh_trgt_merge_simple_pass_intersect_forConcordance.afterchrXQC_check0 %>%
  left_join(eh_cov %>% left_join(trgt_cov)) -> a0


head(a0)
a0 %>% select(ID,STR_ID,allele,eh_meanmapq,trgt_meanmapq) %>%
  pivot_longer(eh_meanmapq:trgt_meanmapq) %>%
  ggplot(aes(x=name,y=value)) +
  geom_violin()

a0 %>% select(ID,STR_ID,allele,eh_meanmapq,trgt_meanmapq) %>%
  pivot_longer(eh_meanmapq:trgt_meanmapq) %>% #head()
  ggplot(aes(x=name,y=value)) +
  geom_density()



a0 %>% select(ID,STR_ID,allele,eh_meanbaseq,trgt_meanbaseq) %>%
  pivot_longer(eh_meanbaseq:trgt_meanbaseq) %>%
  ggplot(aes(x=name,y=value)) +
  geom_violin()
