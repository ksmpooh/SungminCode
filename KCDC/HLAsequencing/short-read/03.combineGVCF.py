...
inDir = "/DATA/smkim/HLA_seq/MHC_Illumina_Rawdata/02.variant.call/GATK"
...
def CombineGVCFs():
    ...
    cmd = cmd + "-O /output/HLA.Shortread.Seq.align.sorted.dedup.GATK_haplotypeCaller_VariantCalling.GATK_CombineGVCF.gvcf.gz"
    #print(cmd)
    os.system(cmd)
...
def genotypeGVCFs():
    ...
    cmd = cmd + "-V /output/HLA.Shortread.Seq.align.sorted.dedup.GATK_haplotypeCaller_VariantCalling.GATK_CombineGVCF.gvcf.gz "
    cmd = cmd + "-O /output/HLA.Shortread.Seq.align.sorted.dedup.GATK_haplotypeCaller_VariantCalling.GATK_CombineGVCF.genotypeGVCF.vcf.gz"
    print(cmd)
    os.system(cmd)
