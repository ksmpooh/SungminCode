...
/BDATA/smkim/TOOL/apt_2.11.8_linux_64_x86_binaries/bin/apt-format-result \
 ...
 --export-plink-file $2/plink/Axiom_KBAv2.0A \
 --plink-sort-by-chrpos True \
 --@export-plink-multiallele-snps True \
 --log-file $2/plink/Axiom_KBAv2.0A_convert.log
...
zcat $2/vcf/Axiom_KBAv2.0A.vcf.gz| grep -v "#" | cut -f3,4,5 | grep -P 'N|AX-643521752' | cut -f1 > varN.txt

#zcat $2/vcf/Axiom_KBAv2.0B.vcf.gz | grep -v "#" | cut -f3,4,5 | grep N | cut -f1 > varN.txt
#
bcftools filter -e 'ID=@varN.txt' $2/vcf/Axiom_KBAv2.0A.vcf.gz | bgzip -c > $2/vcf/Axiom_KBAv2.0A.varN.vcf.gz
#
...
plink \
 ...
 --allow-extra-chr \
 --make-bed \
 --out $2/vcf/Axiom_KBAv2.0A.FINAL_genocall