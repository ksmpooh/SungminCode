...
plot(df$PC1,df$PC2,col=rgb(0,0,1,0.1),xlab = "PC1",ylab = "PC2",main = "1000gnomad with KCHIP(GASTRIC) PCA",cex = 1, pch =16,cex.main = 3)
...
points(df[df$GROUP == "CASE",]$PC1,df[df$GROUP == "CASE",]$PC2,col = rgb(1,0,0,0.1), cex= 1,pch = 16)
