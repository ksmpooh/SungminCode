...
wdir = "/DATA/smkim/Gastric/last_qc_2nd/OUTPUTs/"


# In[151]:


bim = open(wdir+"MERGE/gastric.merge.bim","r")
print("read bim...")
ref = open(wdir+"../INPUTs/Axiom_KOR.annot.extract.addINDEL.Final.REF.txt","r")
print("read.ref...")
out = open(wdir+"MERGE/updateSNPID.txt","w")
print("open write...")
trash = open(wdir+"MERGE/trash.txt","w")
