...
if "Han" in infer_fileName:
    panel_type_path = "/Users/ksmpooh/Desktop/KCDC/HLAimputation/MakeReferencePanel/HLAtype_check/other_panel/hlatype/Han.Nomen.2field"
elif "PanKor" in infer_fileName:
    panel_type_path = "/Users/ksmpooh/Desktop/KCDC/HLAimputation/MakeReferencePanel/HLAtype_check/other_panel/hlatype/PanKor.Nomen.2field"
elif "michigan" in infer_fileName:
    panel_type_path = "/Users/ksmpooh/Desktop/KCDC/HLAimputation/MakeReferencePanel/HLAtype_check/other_panel/hlatype/michigan.Nomen.2field.txt"
elif "1KGP" in infer_fileName:
    panel_type_path = "/Users/ksmpooh/Desktop/KCDC/HLAimputation/MakeReferencePanel/HLAtype_check/other_panel/hlatype/1KGP.Nomen.2field"
else:
    print("panel_type input error!!!!!!!")
    exit()
...
#    fileOut = sys.argv[4]
    ...
    inter4ref = "/Users/ksmpooh/Desktop/KCDC/HLAimputation/MakeReferencePanel/HLAtype_check/other_panel/hlatype/intersect.HLAtype.in4Ref.txt"
    inter4ref = open(inter4ref,'r')
    inter4ref = [s.strip() for s in inter4ref]
    panel_type = [s for s in panel_type if s in inter4ref]
    ...
    print("digit %s, input %s"%(digit,sys.argv[3]))
